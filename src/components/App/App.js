...
import Card from '../Prueba/Card.js';
...
class App extends Component {
  ...
  getherocomic = (characterId) => {
    ...
    var stConvert =
      timeStamp +
      "3dfa3e9a97bf957ec013f696c3a86eeed39fb6d1" +
      "994ff49d3bbd89efaeb4e1a6a4629c55";
    ...
    var HASH = MD5(stConvert);
      ...
      fetch(`${BASE_URL_API}${characterId}/comics&ts=${timeStamp}&apikey=${PUBLIC_KEY}&hash=${HASH}`)
